NETCLASS_EXECS_DIR=/home/blin/netclass-execs
...
CXXFLAGS = -g -ggdb -gstabs+ -Wall -Wno-deprecated -I /usr/include/g++-3 -I /usr/include/c++/3.2.2/ext
...
lib_build_project1: $(LIBMINET) $(LIBMINET_SOCK)
	@echo project1 library build finished.  Now updating libminet.a
	$(AR) ruv $(LIBMINET) ip.o

exec_build_project1: $(EXECOBJS_EXCEPT_READER_WRITER:.o=)
	@echo project1 execs build finished.

project1: lib_build_project1 exec_build_project1
	@echo done.
...
clean: 
	rm -f $(OBJS) $(EXECOBJS:.o=) $(LIBMINET) $(LIBMINET_SOCK) *.log
